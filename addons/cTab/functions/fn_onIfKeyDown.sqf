...
if (_dikCode isEqualTo DIK_F2 && {_displayName in ["cTab_Tablet_dlg"]}) exitWith {
	[_displayName,[["mode","UAV"]]] call cTab_fnc_setSettings;
	true
};
if (_dikCode isEqualTo DIK_F3 && {_displayName in ["cTab_Tablet_dlg"]}) exitWith {
	[_displayName,[["mode","HCAM"]]] call cTab_fnc_setSettings;
	true
};
if (_dikCode isEqualTo DIK_F4 && {_displayName in ["cTab_Tablet_dlg","cTab_Android_dlg"]}) exitWith {
	[_displayName,[["mode","MESSAGE"]]] call cTab_fnc_setSettings;
	true
};
if (_dikCode isEqualTo DIK_F5 && {_displayName in ["cTab_Tablet_dlg","cTab_Android_dlg","cTab_TAD_dlg","cTab_microDAGR_dlg","cTab_FBCB2_dlg"]}) exitWith {
	[_displayName] call cTab_fnc_toggleMapTools;
	true
};
if (_dikCode isEqualTo DIK_F6 && {_displayName in ["cTab_Tablet_dlg","cTab_Android_dlg","cTab_TAD_dlg","cTab_microDAGR_dlg","cTab_FBCB2_dlg"]}) exitWith {
	[_displayName] call cTab_fnc_mapType_toggle;
	true
};
if (_dikCode isEqualTo DIK_F7 && {_displayName in ["cTab_Tablet_dlg","cTab_Android_dlg","cTab_TAD_dlg","cTab_microDAGR_dlg","cTab_FBCB2_dlg"]}) exitWith {
	[_displayName] call cTab_fnc_centerMapOnPlayerPosition;
	true
};
if (_dikCode isEqualTo DIK_DELETE && {cTabCursorOnMap}) exitWith {
